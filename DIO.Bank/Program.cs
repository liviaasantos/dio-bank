...
namespace DIO.Bank
{
    class Program
    {
        ...
        private static void Transferir()
        {
            ...
            int entradaContaOrigem = int.Parse(Console.ReadLine());
            ...
            listContas[entradaContaOrigem].Transferir(valorTransferencia, listContas[entradaContaDestino]);
        }
        ...
        private static void Depositar()
        {
            ...
            listContas[entradaConta].Depositar(valorDeposito);
        }
        ...
        private static void Sacar()
        {
            ...
            listContas[entradaConta].Sacar(valorSaque);
        }
